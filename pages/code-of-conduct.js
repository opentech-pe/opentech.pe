...
export default function CodeOfConduct() {
  return (
    <Layout title="Code Of Conduct | OpenTech">
      <main className="px-3 lg:px-48 md:px-20">
        ...
        <section>
          ...
          <p>
            Nuestro meetup se dedica a ofrecer una experiencia libre de abusos
            para todos, independientemente de su género, orientación sexual,
            discapacidad, apariencia física, talla, raza o religión. No
        ...
        <section>
          ...
          <p>
            ...
            deliberada, acoso, persecusión, fotografía o grabación de abusos,
            interrupciones continuadas de charlas u otros eventos, contacto
            físico inapropiado y atencion sexual no deseada.
          </p>
          <p>
          ...
          <p>
            ...
            miembro del personal del evento inmediatamente. El personal del
            evento puede ser fácilmente identificado, ya que vestirán camisetas
            del evento.
          </p>
          <p>
            El personal del evento estará atento para ayudar a los participantes
            a contactar con la seguridad del lugar del meetup o con las
            ...
            mientras dure el evento. Valoramos tu asistencia. Esperamos que los
            participantes sigan estas reglas durante el evento y talleres
